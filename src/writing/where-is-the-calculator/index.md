---
title: Where is the Calculator? — Data, Power, and Human Intention
description: Where is the Calculator? — Data, Power, and Human Intention. We are at a point in time when agency is shifting from user to system.
date: 2026-03-13
image: images/0.jpg
blend: true
---
![PERSON → USER → DATA → ASSET → AGENT → SYSTEM](images/0.jpg)
...
![ONE FUNCTION, FOUR FACES](images/1.jpg)

Four stages of the same function providing seemingly the same result.

![FROM THING TO BACKGROUND](images/2.jpg)
...
![FROM COMPUTATION TO COMPLETION](images/3.jpg)
...
![FRAMING THE FRAME](images/5.jpg)
...
![SHAPED BY SYSTEMS](images/6.jpg)
...
![THE LOGIC OF ABSTRACTION](images/7.jpg)
...
![FROM ROLE TO FUNCTION](images/8.jpg)
